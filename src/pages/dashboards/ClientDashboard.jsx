    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100">
                ...
                <p className="text-sm text-gray-500 mt-1">Retrouvez les notifications et décisions administratives vous concernant.</p>
            </div>
            {notifications.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100">
                    {notifications.map(n => (
                        <div 
                            key={n.id} 
                            className={`p-5 transition-colors flex items-start gap-4 justify-between ${n.read_at ? 'bg-white' : 'bg-blue-50/20'}`}
                        >
                            <div className="flex items-start gap-3">
                                <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5 ${n.read_at ? 'bg-gray-100 text-gray-400' : 'bg-blue-100 text-blue-600'}`}>
                                    <Bell size={16} />
                                </div>
                                <div>
